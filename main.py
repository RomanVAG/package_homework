...
"""Демонстрация работы модуля "processing" функции "filter_by_state" с транзакциями."""
print("Отмененные транзакции:", filter_by_state(transactions, "CANCELED"))
# Отмененные транзакции:
# [{'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
# {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'}]

"""Демонстрация работы модуля "processing" функции "sort_by_date" с транзакциями."""
print("Отсортированные транзакции по дате:", sort_by_date(transactions))
# Отсортированные транзакции по дате:
# [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
# {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'},
# {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
# {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}]
...
print(
    "Пример декорируемой функции my_function, которая принимает на вход два позиционных аргумента: "
